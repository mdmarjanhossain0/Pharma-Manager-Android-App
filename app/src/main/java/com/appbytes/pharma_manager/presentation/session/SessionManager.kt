...
import com.appbytes.pharma_manager.business.domain.util.SuccessHandling.Companion.RESPONSE_CHECK_PREVIOUS_AUTH_USER_DONE
import com.appbytes.pharma_manager.business.domain.util.SuccessHandling.Companion.SUCCESS_LOGOUT
    ...
    init {
        ...
        sessionScope.launch {
            appDataStoreManager.readValue(DataStoreKeys.PREVIOUS_AUTH_USER)?.let { email ->
                Log.d("AppDebug", "SessionManager " + email.toString())
