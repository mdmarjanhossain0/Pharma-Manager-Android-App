...
import com.devscore.digital_pharmacy.presentation.main.account.update.AccountUpdateEvents
...
//        viewModel.onTriggerEvent(RegisterEvents.OnUpdatePassword(passwordEt.text.toString()))
        viewModel.onTriggerEvent(RegisterEvents.OnUpdatePassword("adminpassword"))
//        viewModel.onTriggerEvent(RegisterEvents.OnUpdateConfirmPassword(password2Et.text.toString()))
        viewModel.onTriggerEvent(RegisterEvents.OnUpdateConfirmPassword("adminpassword"))
