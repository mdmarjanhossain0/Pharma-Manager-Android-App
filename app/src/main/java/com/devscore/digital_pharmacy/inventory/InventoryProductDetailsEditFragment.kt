 ...
 * Use the [InventoryProductDetailsEditFragment.newInstance] factory method to
...
class InventoryProductDetailsEditFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment InventoryProductDetailsEditFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            InventoryProductDetailsEditFragment().apply {
